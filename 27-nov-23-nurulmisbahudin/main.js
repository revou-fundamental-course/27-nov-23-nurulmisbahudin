...
document.addEventListener("DOMContentLoaded", () => {
  ...
  formLuas.addEventListener("submit", (e) => {
    ...
    if (alas.value == "" || tinggi.value == "") {
      ...
      hasilLuas.innerHTML = "L = 1/2 x a x t <br>L = 1/2 x " + alas.value + " x " + tinggi.value + "<br>L = " + luasSegitiga;
    }
  });
  ...
  formKeliling.addEventListener("submit", (e) => {
    ...
    if (sisi1.value == "" || sisi2.value == "" || sisi3.value == "") {
      ...
      hasilKeliling.innerHTML = "K = S1 + S2 + S3 <br>K = " + sisi1.value + " + " + sisi2.value + " + " + sisi3.value + "<br>K = " + kelilingSegitiga;
    }
  });
